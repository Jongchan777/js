...
# Find the element that contains the text you want to extract
total_money_text = driver.find_element(By.CSS_SELECTOR, "div.css-1m1xcoz")

# Extract the text from the element
text = total_money_text.text

# Use a regular expression to extract only the numbers
total_money = re.findall('\d+', text)

# Join the extracted numbers into a single string
total_money_joined1 = int(''.join(total_money))

# Print the joined numbers
only_money_text = driver.find_elements(By.CSS_SELECTOR, "span.css-1l75r3e")[0]
only_gift_text = driver.find_elements(By.CSS_SELECTOR, "span.css-1l75r3e")[1]

only_money = re.findall('\d+', only_money_text.text)
only_gift = re.findall('\d+', only_gift_text.text)
# Join the extracted numbers into a single string
only_money_joined1 = int(''.join(only_money))
only_gift_joined1 = int(''.join(only_gift))

print(total_money_joined1)
print(only_money_joined1)
print(only_gift_joined1)

if total_money_joined1 == only_money_joined1+only_gift_joined1:
    print("금액이 맞습니다.")
else:
    print("금액 에러가 있습니다.")
...
text = total_money_text.text
total_money = re.findall('\d+', text)
total_money_joined2 = int(''.join(total_money))

only_money_text = driver.find_elements(By.CSS_SELECTOR, "span.css-1l75r3e")[0]
only_gift_text = driver.find_elements(By.CSS_SELECTOR, "span.css-1l75r3e")[1]
only_money = re.findall('\d+', only_money_text.text)
only_gift = re.findall('\d+', only_gift_text.text)
only_money_joined2 = int(''.join(only_money))
only_gift_joined2 = int(''.join(only_gift))

print(total_money_joined2)
print(only_money_joined2)
print(only_gift_joined2)

if total_money_joined2 == only_money_joined2+only_gift_joined2:
    print("금액이 맞습니다.")
else:
    print("금액 에러가 있습니다.")

if total_money_joined2 == total_money_joined1-selected_item_price_value:
    print("산 물품을 제외한 토탈 머니가 맞습니다.")
else:
    print("금액 에러가 있습니다.")

if only_money_joined2 == only_money_joined1-selected_item_price_value:
    print("산 물품을 제외한 유찜 머니가 맞습니다.")
else:
    print("금액 에러가 있습니다.")
...
# ['주문취소'] 버튼 선택
driver.find_element(By.CSS_SELECTOR, '.css-yec7ih').click()
driver.implicitly_wait(10)
time.sleep(2)
...
# ['쇼핑 계속하기'] 버튼 선택
driver.find_elements(By.CSS_SELECTOR, "button[type=button].css-3hyl58")[0].click()
driver.implicitly_wait(10)
time.sleep(2)
...
text = total_money_text.text
total_money = re.findall('\d+', text)
total_money_joined3 = int(''.join(total_money))

only_money_text = driver.find_elements(By.CSS_SELECTOR, "span.css-1l75r3e")[0]
only_gift_text = driver.find_elements(By.CSS_SELECTOR, "span.css-1l75r3e")[1]
only_money = re.findall('\d+', only_money_text.text)
only_gift = re.findall('\d+', only_gift_text.text)
only_money_joined3 = int(''.join(only_money))
only_gift_joined3 = int(''.join(only_gift))

print(total_money_joined3)
print(only_money_joined3)
print(only_gift_joined3)

if total_money_joined3 == only_money_joined3+only_gift_joined3:
    print("금액이 맞습니다.")
else:
    print("금액 에러가 있습니다.")

if total_money_joined3 == total_money_joined2:
    print("산 물품을 제외한 토탈 머니가 맞습니다.")
else:
    print("금액 에러가 있습니다.")

if only_gift_joined3 == only_gift_joined2+selected_item_price_value:
    print("산 물품을 제외한 유찜 머니가 맞습니다.")
else:
    print("금액 에러가 있습니다.")
